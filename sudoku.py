...
#         self._screen.vline(0, 4 * 3 - 2, curses.A_VERTICAL, 2 * 9 - 1)
#         self._screen.vline(0, 4 * 6 - 2, curses.A_VERTICAL, 2 * 9 - 1)
#         self._screen.hline(2 * 3 - 1, 0, curses.A_HORIZONTAL, 4 * 9 - 3)
#         self._screen.hline(2 * 6 - 1, 0, curses.A_HORIZONTAL, 4 * 9 - 3)
